...
public class Utils
{
    public class LootGenerator
    {
        ...
        private void GenerateChunk(int chunkValue, List<PomoSasyConstants.CoinType> output)
        {
            ...
            while (remaining > 0)
            {
                ...
                var chosen = validCoins
                    .OrderByDescending(kv => kv.Value + _rng.Next(-_valueJitter, _valueJitter + 1))
                    .First();
    
                output.Add(chosen.Key);
